                    ...
                    <div className="flex flex-col lg:flex-row-reverse items-center justify-center lg:justify-evenly mt-8">
                        <div className="flex flex-col items-center justify-center order-2 lg:order-none">
                            <div className="flex flex-col items-center my-4">
                                ...
                                <a href={data.projects[id].pageLink} target={"_blank"} className='text-xl underline  cursor-pointer mt-4'>Ir até a página</a>
                            </div>
                            <div className="flex flex-col items-center my-4">
                            ...
                            <div className="flex flex-col items-center my-4">
                                ...
                                onClick={data.projects[id].privacy === true ? handleLink : doNot}>Ver o código</a>
                            </div>
                        </div>
